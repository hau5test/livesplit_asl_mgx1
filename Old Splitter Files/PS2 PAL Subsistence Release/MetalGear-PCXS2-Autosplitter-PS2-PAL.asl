state("pcsx2") {
	uint GameTime: 0x123E194, 0xC0;
	uint BSGameTimeSeconds: 0x123E194, 0x790;
    uint BSGameTimeMinutes: 0x123E194, 0x78C;
    uint BSState: 0x123E194, 0x7EC;
	uint FloorVal: 0x123E194, 0x9C0;
	uint SubFloorVal: 0x123EB14, 0xA84;
	uint RankVal: 0x123E190, 0xF64;
	uint ContPerCheckpoint: 0x123E194, 0x2A0;
	uint Continues: 0x123E194, 0xD8;
	uint Alerts: 0x123E194, 0xCC;
	uint Kills: 0x123E194, 0xC8;
	uint Rations: 0x123E194, 0xC4;
	uint TotalPOWsaved: 0x123E194, 0x4;
	uint RationsHeld: 0x123E190, 0xFF0;
	uint AlertCountdown: 0x123E194, 0x750;
	uint Health: 0x123E190, 0xF54;
	uint PlasticExplosives: 0x123E194, 0xA8;
	uint Mines: 0x123E194, 0xA4;
	uint RemoteMissiles: 0x123E194, 0xAC;
	uint RocketLauncherAmmo: 0x123E194, 0xB8;
	uint GrenadeLauncherAmmo: 0x123E194, 0xBC;
	uint SMGAmmo: 0x123E194, 0xB4;
	uint PistolAmmo: 0x123E194, 0xB0;
    uint Saves: 0x123E194, 0xD4;
}

gameTime {
	return current.BSGameTimeSeconds == 0?TimeSpan.FromMilliseconds(current.GameTime * 1000 / 16.667):TimeSpan.FromMilliseconds((current.BSGameTimeMinutes * 60 + current.BSGameTimeSeconds) * 1000);
}
