state("pcsx2") {
	uint GameTime: 0x123E184, 0x9F0;
	uint BSGameTimeSeconds: 0x123E188, 0xC0;
    uint BSGameTimeMinutes: 0x123E188, 0xBC;
    uint BSState: 0x123E188, 0x11C;
	uint FloorVal: 0x123E188, 0x78;
	uint SubFloorVal: 0x11E540C, 0x684;
	uint RankVal: 0x123E184, 0x894;
	uint ContPerCheckpoint: 0x123E184, 0xBD0;
	uint Continues: 0x123E184, 0xA08;
	uint Alerts: 0x123E184, 0x9FC;
	uint Kills: 0x123E184, 0x9F8;
	uint Rations: 0x123E184, 0x9F4;
	uint TotalPOWsaved: 0x123E184, 0x934;
	uint RationsHeld: 0x123E184, 0x920;
	uint AlertCountdown: 0x123E188, 0x80;
	uint Health: 0x123E184, 0x884;
	uint PlasticExplosives: 0x123E184, 0x9D8;
	uint Mines: 0x123E184, 0x9D4;
	uint RemoteMissiles: 0x123E184, 0x9DC;
	uint RocketLauncherAmmo: 0x123E184, 0x9E8;
