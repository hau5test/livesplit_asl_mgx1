state("pcsx2") {
	uint GameTime: 0x123E188, 0x388;
	uint BSGameTimeSeconds: 0x123E188, 0xA58;
    uint BSGameTimeMinutes: 0x123E188, 0xA54;
    uint BSState: 0x123E188, 0xAB4;
	uint FloorVal: 0x123E188, 0xA10;
	uint SubFloorVal: 0x123EB08, 0xC04;
	uint RankVal: 0x123E188, 0x22C;
	uint ContPerCheckpoint: 0x123E188, 0x568;
	uint Continues: 0x123E188, 0x3A0;
	uint Alerts: 0x123E188, 0x394;
	uint Kills: 0x123E188, 0x390;
	uint Rations: 0x123E188, 0x38C;
	uint TotalPOWsaved: 0x123E188, 0x2CC;
	uint RationsHeld: 0x123E188, 0x2B8;
	uint AlertCountdown: 0x123E188, 0xA18;
	uint Health: 0x123E188, 0x21C;
	uint PlasticExplosives: 0x123E188, 0x370;
	uint Mines: 0x123E188, 0x36C;
	uint RemoteMissiles: 0x123E188, 0x374;
	uint RocketLauncherAmmo: 0x123E188, 0x380;
	uint GrenadeLauncherAmmo: 0x123E188, 0x384;
	uint SMGAmmo: 0x123E188, 0x37C;
	uint PistolAmmo: 0x123E188, 0x378;
    uint Saves: 0x123E188, 0x39C;
}
